...
We will load the shapefile with all FishMIP regional model boundaries and add a unique ID identifying each region.  
...
Our shapefile is plotting correctly, now we can move onto creating raster masks. In total, we will create four different multidimensional raster masks to match all data available as forcings for FishMIP models.  
  
# Finding location of raster samples
We have a folder containing samples of the raster used in FishMIP models and ESMs. We will list all the files contained in that folder.    
