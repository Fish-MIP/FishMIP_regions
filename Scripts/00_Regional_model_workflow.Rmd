...
subgraph sub_1 {
  ...
  Step_1 -> Step_2 
  Step_2 -> Step_3
  Step_3 -> Step_n [style = dotted penwidth = 5]
  Step_n -> Step_5 [label = 'No' fontcolor = '#000000' style = dotted color = ''#00000080' 
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 5 fontsize = 40]
  Step_n -> Step_4 [label = 'Yes' fontcolor = '#000000' style = dotted color = ''#00000080'
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 5 fontsize = 40]
