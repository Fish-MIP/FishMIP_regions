...
subgraph sub_2 {
  Step_n -> Step_4 [label = 'Yes' fontcolor = '#d8582d' style = dotted color = '#d8582d'
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 6 fontsize = 45]
  Step_n -> Step_5 [label = 'No' fontcolor = '#194c19' style = dotted color = '#194c19' 
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 6 fontsize = 45]
  {Step_4 Step_5} -> Step_6 [weight = 1]
