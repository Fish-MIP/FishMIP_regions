...
subgraph sub_1 {
  ...
  Step_2 -> Step_3
  Step_3 _> Step_4 
  Step_4 _> Step_n [style = dotted penwidth = 5]
  Step_n -> Step_5 [label = 'No' fontcolor = '#000000' style = dotted color = '#194c19' 
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 5 fontsize = 40]
  Step_n -> Step_5 [label = 'Yes' fontcolor = '#000000' style = dotted color = '#d8582d'
                    fontname = 'bold Helvetica,Arial,sans-serif' penwidth = 5 fontsize = 40]
